          ...
          <form onSubmit={handleUpdate} className="space-y-4">
            ...
            <div className="pt-2">
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700" disabled={isLoading}>
                {isLoading ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : "Alterar Senha e Entrar"}
              </Button>
            </div>
            
            <div className="text-center pt-2">
               <Button variant="link" type="button" onClick={() => router.push("/auth")} className="text-slate-500 text-xs">
