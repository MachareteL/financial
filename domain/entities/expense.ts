...
export class Expense {
  ...
  get owner(): { name: string } | null | undefined {
  ...
  get recurrenceType(): "monthly" | "weekly" | "yearly" | null | undefined {
