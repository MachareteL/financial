...
export type UpdateIncomeProps = Partial<
  Pick<IncomeProps, "amount" | "description" | "type" | "frequency" | "date">
>;
...
export class Income {
  ...
  get type(): "recurring" | "one_time" {
    return this.props.type;
  }
  get frequency(): "monthly" | "weekly" | "yearly" | null | undefined {
  ...
  public isMonthlyRecurring(): boolean {
    return (
      this.props.type === "recurring" && this.props.frequency === "monthly"
    );
  }
  ...
  public update(dto: UpdateIncomeProps): Income {
    const newProps = {
      ...
      frequency:
        dto.type === "one_time" ||
        (dto.type === undefined && this.props.type === "one_time")
          ? null
