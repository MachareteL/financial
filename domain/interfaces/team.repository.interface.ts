...
export interface ITeamRepository {
  ...
  updateMemberRole(teamId: string, memberId: string, roleId: string | null): Promise<void>;
  ...
  deleteTeamInvite(inviteId: string, teamId: string): Promise<void>; // Cancelar convite
}